...
(eval-and-compile
  ...
  (autothemer-deftheme
   ...
   ((default (:background bg :foreground fg))
    ...
    (transient-key-stack (:foreground violet :weight 'bold :inherit 'transient-key))
    ...
    (transient-key-exit (:foreground orange :inherit 'transient-key))
    ...
    (transient-key (:inherit 'font-lock-keyword-face :weight 'normal))
    ...
    (transient-heading (:weight 'bold :inherit 'font-lock-function-name-face))
    ...
    (orderless-match-face-3 (:weight 'bold :underline t :foreground yellow))
    (orderless-match-face-2 (:weight 'bold :underline t :foreground blue))
    (orderless-match-face-1 (:weight 'bold :underline t :foreground red))
    (orderless-match-face-0 (:weight 'bold :underline t :foreground orange))
    ...
    (font-lock-variable-name-face (:foreground base9))
    ...
    (font-lock-doc-face (:foreground violet :inherit 'font-lock-comment-face))
    ...
    (mode-line-inactive
     (:box (:line-width '(6 . 6) :color bg-alt) :foreground base5 :background bg-alt :inherit 'mode-line))
    (mode-line-active
     (:box (:line-width '(6 . 6) :color base3) :background base3 :inherit 'mode-line))
    (mode-line
     (:box (:line-width '(6 . 6) :color base3) :foreground base8 :background base3 :height 0.8 :weight 'bold))
    ...
    (line-number
     (:weight 'normal :foreground base6 :inherit 'default))
    ...
    (erc-fill-wrap-merge-indicator-face (:foreground base6))
    ...
    (erc-fool-face (:foreground base6))
    ...
    (nerd-icons-dsilver (:foreground base6))
    (nerd-icons-lsilver (:foreground base7))
    (nerd-icons-silver (:foreground base6))
    ...
    (nerd-icons-dmaroon (:foreground base6))
    ...
    (ediff-odd-diff-Ancestor (:extend t :background base6))
    (ediff-odd-diff-C (:extend t :background base6))
    (ediff-odd-diff-B (:extend t :background base6))
    (ediff-odd-diff-A (:extend t :background base6))
    (ediff-even-diff-Ancestor (:extend t :background base6))
    (ediff-even-diff-C (:extend t :background base6))
    (ediff-even-diff-B (:extend t :background base6))
    ...
    (org-agenda-dimmed-todo-face (:foreground base6))
    ...
    (org-column-title (:weight 'bold :underline t :background base3))
    (org-column
    ...
    (whitespace-tab (:foreground base6 :background base3))
    (whitespace-hspace (:foreground base6 :background base3))
    (whitespace-space (:foreground base6 :background bg-alt))
    (yas--field-debug-face nil)
    (yas-field-highlight-face (:inherit 'region))
    (diff-hl-margin-reference-change (:inherit 'diff-hl-reference-change))
    (diff-hl-margin-reference-delete (:inherit 'diff-hl-reference-delete))
    (diff-hl-margin-reference-insert (:inherit 'diff-hl-reference-insert))
    (diff-hl-margin-unknown (:inherit 'dired-ignored))
    (diff-hl-margin-ignored (:inherit 'dired-ignored))
    (diff-hl-margin-change (:inherit 'diff-hl-change))
    (diff-hl-margin-delete (:inherit 'diff-hl-delete))
    (diff-hl-margin-insert (:inherit 'diff-hl-insert))
    (diff-hl-dired-ignored (:inherit 'dired-ignored))
    (diff-hl-dired-unknown (:inherit 'dired-ignored))
    (diff-hl-dired-change (:inherit 'diff-hl-change))
    (diff-hl-dired-delete (:inherit 'diff-hl-delete))
    (diff-hl-dired-insert (:inherit 'diff-hl-insert))
    (eglot-code-action-indicator-face
     (:weight 'bold :inherit 'font-lock-escape-face))
    (elisp-completion-category-definition (:inherit 'elisp-completion-category))
    (elisp-completion-category (:inherit 'font-lock-type-face))
    (elisp-defcharset (:inherit 'elisp-charset))
    (elisp-charset (:inherit 'font-lock-type-face))
    (elisp-defcoding (:inherit 'elisp-coding))
    (elisp-coding (:inherit 'font-lock-type-face))
    (elisp-defoclosure (:inherit 'elisp-oclosure))
    (elisp-oclosure (:inherit 'font-lock-type-face))
    (elisp-deficon (:inherit 'elisp-icon))
    (elisp-icon (:inherit 'font-lock-type-face))
    (elisp-defface (:inherit 'font-lock-variable-name-face))
    (elisp-defvar (:inherit 'font-lock-variable-name-face))
    (elisp-defmacro (:inherit 'elisp-defun))
    (elisp-defun (:inherit 'font-lock-function-name-face))
    (elisp-constant (:inherit 'font-lock-builtin-face))
    (elisp-ampersand (:inherit 'font-lock-type-face))
    (elisp-nnoo-backend (:inherit 'font-lock-type-face))
    (elisp-group (:inherit 'font-lock-type-face))
    (elisp-type (:inherit 'font-lock-type-face))
    (elisp-widget-type (:inherit 'font-lock-type-face))
    (elisp-slot (:inherit 'font-lock-builtin-face))
    (elisp-thing (:inherit 'font-lock-type-face))
    (elisp-function-property-declaration (:inherit 'font-lock-variable-use-face))
    (elisp-warning-type (:inherit 'font-lock-type-face))
    (elisp-variable-at-point (:inherit 'bold))
    (elisp-shadowed-variable (:underline t :inherit 'elisp-bound-variable))
    (elisp-shadowing-variable (:underline t :inherit 'elisp-binding-variable))
    (elisp-bound-variable
     (:slant 'italic :foreground 'reset :inherit 'font-lock-variable-use-face))
    (elisp-binding-variable (:slant 'italic :inherit 'font-lock-variable-name-face))
    (elisp-theme (:inherit 'font-lock-constant-face)) (elisp-rx (:foreground blue))
    (elisp-feature (:inherit 'font-lock-constant-face))
    (elisp-throw-tag (:inherit 'font-lock-constant-face))
    (elisp-special-form (:inherit 'elisp-macro))
    (elisp-macro (:inherit 'font-lock-keyword-face))
    (elisp-unknown-call (:foreground teal :inherit 'elisp-function))
    (elisp-non-local-exit (:underline orange :inherit 'elisp-function))
    (elisp-function (:inherit 'font-lock-function-call-face))
    (elisp-symbol-role-definition
     (:foreground blue :inherit 'font-lock-function-name-face))
    (elisp-symbol-role (:foreground blue :inherit 'font-lock-function-call-face))
    (elisp-face (:inherit 'font-lock-type-face))
    (elisp-major-mode-name (:foreground green))
    (elisp-condition (:foreground orange))
    (elisp-special-variable-declaration (:inherit 'elisp-free-variable))
    (elisp-free-variable
     (:underline t :foreground 'reset :inherit 'font-lock-variable-use-face))
    (elisp-symbol-at-mouse (:background base1)))))
