...
(eval-and-compile
  ...
  (autothemer-deftheme
   ...
   ((default (:background bg :foreground fg))
    ...
    (orderless-match-face-3 (:weight 'bold :foreground blue))
    (orderless-match-face-2 (:weight 'bold :foreground red))
    (orderless-match-face-1 (:weight 'bold :foreground yellow))
    (orderless-match-face-0 (:weight 'bold :foreground green))
