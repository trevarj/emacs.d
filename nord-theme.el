...
(autothemer-deftheme
 ...
 ((default (:background bg :foreground fg))
  ...
  (erc-nicks-emfrom-face
   (:foreground base7 :inherit 'erc-button-nick-default-face))
  (erc-nicks-sachac-face
   (:foreground blue :inherit 'erc-button-nick-default-face))
  (erc-nicks-interface02-face
   (:foreground blue :inherit 'erc-button-nick-default-face))
  (erc-nicks-zleap-face
   (:foreground orange :inherit 'erc-button-nick-default-face))
  (erc-nicks-joebiden606728-face
   (:foreground blue :inherit 'erc-button-nick-default-face))
  (erc-nicks-odin-face (:foreground teal :inherit 'erc-button-nick-default-face))
  (erc-nicks-s-liao-200-face
   (:foreground cyan :inherit 'erc-button-nick-default-face))
  (erc-nicks-joetriden115898-face
   (:foreground orange :inherit 'erc-button-nick-default-face))
  (erc-nicks-radhitya-face
   (:foreground blue :inherit 'erc-button-nick-default-face))
  (erc-nicks-germ-face
   (:foreground orange :inherit 'erc-button-nick-default-face))
