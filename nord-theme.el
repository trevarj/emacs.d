...
(autothemer-deftheme
 ...
 ((default (:background bg :foreground fg))
  ...
  (flymake-warning (:underline (:style 'wave :color cyan)))
  (flymake-error (:underline (:style 'wave :color orange)))
  ...
  (ediff-fine-diff-C (:background green)) (ediff-fine-diff-B (:background green))
  ...
  (org-mode-line-clock (:inherit 'mode-line)) (org-tag-group (:inherit 'org-tag))
  ...
  (org-scheduled-today (:foreground green)) (org-scheduled (:foreground green))
  ...
  (org-verse (:inherit 'org-block)) (org-quote (:inherit 'org-block))
  (org-verbatim (:inherit 'shadow)) (org-inline-src-block (:inherit 'org-block))
  ...
  (org-code (:inherit 'shadow)) (org-formula (:foreground orange))
  (org-table-header (:foreground base0 :background base7 :inherit 'org-table))
  (org-table-row (:inherit 'org-table)) (org-table (:foreground cyan))
  ...
  (org-headline-todo (:foreground magenta)) (org-agenda-done (:foreground green))
  (org-done (:weight 'bold :foreground green))
  (org-todo (:weight 'bold :foreground magenta)) (org-list-dt (:weight 'bold))
  (org-tag (:weight 'bold)) (org-sexp-date (:foreground teal))
  (org-date-selected (:inverse-video t :foreground magenta))
  (org-date (:underline t :foreground teal)) (org-target (:underline t))
  (org-ellipsis (:underline t :foreground yellow))
  (org-footnote (:underline t :foreground teal)) (org-link (:inherit 'link))
  (org-cite-key (:inherit 'link)) (org-cite (:inherit 'link))
  ...
  (org-hide (:foreground bg)) (org-default (:inherit 'default))
  ...
  (holiday (:background red)) (diary (:foreground yellow))
  ...
  (embark-target (:inherit 'highlight)) (embark-keymap (:slant 'italic))
  ...
  (forge-post-date (:inherit 'italic)) (forge-post-author (:inherit 'bold))
  (forge-topic-label
  ...
  (forge-issue-completed (:inherit 'forge-dimmed)) (forge-issue-open nil)
  ...
  (forge-discussion-open (:slant 'italic)) (forge-topic-done nil)
  ...
  (bui-action-button (:inherit 'custom-button)) (bui-url (:inherit 'link))
  (bui-file-name (:inherit 'link)) (bui-time (:inherit 'font-lock-constant-face))
  (guix-false (:weight 'bold)) (guix-true (:weight 'bold :foreground green))
  ...
  (minibuffer-nonselected (:weight 'bold :foreground red :background yellow))))
