...
(autothemer-deftheme
 ...
 ((default (:background bg :foreground fg))
  ...
  (magit-header-line
   (:weight 'bold :box (:line-width 3 :color dark-blue) :foreground base8
  ...
  (help-key-binding
   (:box (:line-width '(-1 . -1) :color base5) :foreground cyan :background bg-alt
         :inherit 'fixed-pitch))
  ...
  (highlight (:foreground fg :background blue))
