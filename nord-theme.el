...
(autothemer-deftheme
 ...
 ((((class color) (min-colors #xFFFFFF)))
  ...
  (base5-alt2 (color-lighten-hex base5 0.2))
  (base6      "#9099AB")
  (base7      "#D8DEE9")
  (base8      "#F0F4FC")
  (fg         "#ECEFF4")
 ...
 ((default (:background bg :foreground fg))
  ...
  (magit-section-highlight (:extend t :inherit 'hl-line))
  ...
  (header-line-inactive (:inherit 'header-line))
  (header-line-active (:inherit 'header-line))
  ...
  (corfu-border (:background bg-alt)) (corfu-bar (:background base6))
  (corfu-current (:extend t :foreground fg :background bg))
  ...
  (header-line (:inherit 'mode-line)) (mode-line-buffer-id (:weight 'bold))
  (mode-line-emphasis (:foreground blue))
  (mode-line-highlight (:inherit 'highlight))
  (mode-line-inactive
   (:box (:line-width '(6 . 6) :color base3) :foreground base5 :background base3))
  (mode-line-active
  ...
  (highlight (:foreground fg :background base3))
  ...
  (elfeed-search-unread-title-face (:weight 'bold))
  (elfeed-search-title-face (:foreground fg))
  (elfeed-search-date-face (:foreground grey))
